...
const SPECIALTIES = [
  {
    ...
    valueProp: 'MEDACCER contacta automáticamente al paciente que no aceptó el tratamiento, le ofrece facilidades de pago y agenda la cita.',
    bigNumber: { value: '$10.8M COP', label: 'perdidos al mes en no-shows en un consultorio dental promedio' },
    ...
    useCases: [
      'Agenda limpiezas, ortodoncia, endodoncia y urgencias en segundos',
      'Recuerda controles de ortodoncia automáticamente cada 21 días',
      'Gestiona presupuestos y abonos de tratamientos largos sin llamadas',
    ],
  },
  {
    id: 'cirugia-plastica',
    ...
    pain: 'Un paciente insatisfecho post-cirugía puede destruir su reputación en Google e Instagram con una sola reseña.',
    valueProp: 'MEDACCER envía secuencias de seguimiento automáticas y alerta al cirujano si el paciente reporta algo anormal.',
    bigNumber: { value: '78%', label: 'de demandas en cirugía plástica por falta de comunicación post-operatoria' },
    ...
    useCases: [
      'Secuencias post-quirúrgicas automáticas del día 1 al 90 sin intervención',
      'Instrucciones pre-quirúrgicas con checklist interactivo y confirmación',
      'Detección de alertas: dolor anormal → escala inmediatamente al cirujano',
    ],
  },
  {
    id: 'dermatologia',
    ...
    pain: 'Pacientes envían fotos de manchas a cualquier hora esperando diagnóstico gratis.',
    valueProp: 'MEDACCER recibe las fotos, las organiza en la ficha y convierte cada consulta en una cita pagada.',
    bigNumber: { value: '4 horas', label: 'por semana que pierde un dermatólogo en consultas gratis por WhatsApp' },
    ...
    useCases: [
      'Recibe fotos de pacientes y las organiza automáticamente en su ficha clínica',
      'Seguimiento fotográfico de evolución de lesiones con historial visual',
      'Convierte consultas gratis por WhatsApp en citas pagadas',
    ],
  },
  {
    id: 'psicologia',
    ...
    pain: '40% de los pacientes cancela por vergüenza o ansiedad antes de la cita.',
    valueProp: 'Check-ins empáticos que reducen la ansiedad pre-cita y el abandono del proceso terapéutico.',
    bigNumber: { value: '$2.4M COP', label: 'al mes recupera un consultorio de 2 psicólogos reduciendo cancelaciones de sesiones' },
    ...
    useCases: [
      'Check-ins empáticos entre sesiones con lenguaje adaptado y discreto',
      'Recordatorios discretos que no revelan el motivo de la cita',
      'Cifrado extremo y confidencialidad total — cumple Ley 1581',
    ],
  },
  {
    id: 'nutricion',
    ...
    pain: 'El paciente no sigue el plan y no regresa a controles, perdiendo el tratamiento.',
    valueProp: 'Check-in semanal + reporte automático de adherencia al plan enviado a la nutricionista antes de cada control.',
    bigNumber: { value: '70%', label: 'de los pacientes abandona el plan nutricional en las primeras 2 semanas' },
    ...
    useCases: [
      'Check-in semanal de adherencia al plan con respuestas interactivas',
      'Reporte de adherencia automático para la nutricionista antes de cada control',
      'Recetas y recordatorios de hidratación personalizados',
    ],
  },
  {
    id: 'fisioterapia',
    ...
    pain: 'Tratamientos de 20 sesiones con abandono masivo a la mitad — pagado y no completado.',
    valueProp: 'Tracker de ejercicios en casa + barra de progreso visual que motiva al paciente a completar el tratamiento.',
    bigNumber: { value: '60%', label: 'de los pacientes abandona el tratamiento antes de completar las sesiones prescritas' },
    ...
    useCases: [
      'Tracker diario de ejercicios en casa con barra de progreso motivacional',
      'Reporte de adherencia para el fisioterapeuta antes de cada sesión',
      'Recuerda cuándo debe volver y llena la agenda de la semana',
    ],
  },
  {
    id: 'ginecologia',
    ...
    pain: 'La paciente olvida exámenes y controles críticos del embarazo por falta de recordatorios personalizados.',
    valueProp: 'Timeline automático semana a semana: vacunas, ecografías, exámenes y controles en el momento exacto.',
    bigNumber: { value: '30+', label: 'fechas críticas en un embarazo que el paciente puede olvidar sin seguimiento' },
    ...
    useCases: [
      'Timeline automático semana a semana con recordatorios de controles y exámenes',
      'Agenda vacunas, ecografías y exámenes en el momento correcto del embarazo',
      'Responde dudas frecuentes del embarazo 24/7 con tono empático',
    ],
  },
  {
    id: 'pediatria',
    ...
    pain: 'El pediatra no puede estar disponible 24/7, pero los padres sí tienen preguntas a cualquier hora.',
    valueProp: 'Ada responde 24/7 con protocolos seguros y agenda la cita si la situación lo requiere — sin despertar al médico.',
    bigNumber: { value: '11PM', label: 'hora promedio en que los padres preguntan por síntomas de sus hijos' },
    metric: '24/7', metricLabel: 'respuesta a dudas de padres con protocolos pediátricos seguros',
    features: [
    ...
    useCases: [
      'Responde preguntas de padres 24/7 con protocolos pediátricos seguros',
      'Calendario de vacunación personalizado por hijo con recordatorios',
      'Seguimiento de controles de crecimiento mes a mes',
    ],
  },
  {
    id: 'oftalmologia',
    ...
    pain: 'El paciente no cumple la preparación pre-quirúrgica y hay que reprogramar una cirugía de $3-8M COP.',
    valueProp: 'Checklist interactivo con confirmación obligatoria — si el paciente no confirma, Ada hace seguimiento hasta obtener respuesta.',
    bigNumber: { value: '$3-8M', label: 'COP por cirugía refractiva que se pierde cuando el paciente no confirma preparación' },
    ...
    useCases: [
      'Checklist interactivo pre-operatorio con confirmación obligatoria del paciente',
      'Seguimiento post-LASIK: visión, molestias, gotas en los momentos exactos',
      'Recuerda controles anuales con el oftalmólogo',
    ],
  },
];
...
const SCRIPT_OVERRIDES = {
  'odontologia': {
    agendar: [
      { from: 'patient', text: 'Cuánto cuesta el diseño de sonrisa?', delay: 700 },
      { from: 'typing', delay: 900 },
      { from: 'bot', text: `¡Hola! El diseño de sonrisa incluye valoración + diseño digital + carillas. Valor desde $2.500.000.\n\n¿Le agendo una valoración?\n📅 Jueves 3:00 PM\n📅 Viernes 10:00 AM`, delay: 1500 },
      { from: 'patient', text: 'El jueves está bien', delay: 1100 },
      { from: 'typing', delay: 600 },
      { from: 'bot', text: `✅ Cita agendada: Jue 15 mayo, 3:00 PM.\n🦷 Valoración Diseño de Sonrisa.\n\nLe enviaré recordatorio 24h antes.`, delay: 1300 },
    ],
    confundido: [
  ...
  'cirugia-plastica': {
    ...
    'post-op': [
      { from: 'bot', text: `Hola María, ¿cómo se siente hoy? (Día 3 post-rinoplastia)\n\nEs normal tener hinchazón y moretones. ¿Tiene alguno de estos síntomas?\n1️⃣ Dolor intenso\n2️⃣ Sangrado abundante\n3️⃣ Todo normal ✅`, delay: 700 },
      { from: 'patient', text: '3', delay: 1300 },
      { from: 'typing', delay: 800 },
      { from: 'bot', text: `¡Excelente! Su recuperación va muy bien.\n\nRecuerde: no agacharse, dormir boca arriba.\n\nSu próximo control es el viernes 18 a las 10AM. ✅`, delay: 1500 },
    ],
  },
  'dermatologia': {
    agendar: [
    ...
    foto: [
      { from: 'patient', text: '[📷 Foto] Doctor, me salió esto en el brazo', delay: 700 },
      { from: 'typing', delay: 1100 },
      { from: 'bot', text: `Gracias por compartir la imagen. La guardamos en su ficha clínica para que el Dr. García la revise.\n\nPara evaluación completa necesitamos consulta presencial. ¿Le agendo?\n📅 Miércoles 2:00 PM\n📅 Jueves 11:00 AM`, delay: 1700 },
    ],
  },
  'psicologia': {
    agendar: [
    ...
    'check-in': [
      { from: 'bot', text: `Hola María, ¿cómo se ha sentido esta semana? No es necesario que entre en detalles, solo quiero saber cómo está. 💙`, delay: 700 },
      { from: 'patient', text: 'Mejor que la semana pasada, gracias', delay: 1500 },
      { from: 'typing', delay: 1100 },
      { from: 'bot', text: `Me alegra saberlo. 😊 Recuerde que su próxima sesión es el jueves a las 3:00 PM. ¿Confirma?`, delay: 1400 },
      { from: 'patient', text: 'Sí, ahí estaré', delay: 1100 },
      { from: 'bot', text: `Perfecto, ¡la esperamos! 🌿`, delay: 900 },
    ],
    confundido: [
  ...
  'nutricion': {
    ...
    'check-in': [
      { from: 'bot', text: `¡Hola Carlos! ¿Cómo le fue con la alimentación esta semana?\n1️⃣ Seguí el plan 💪\n2️⃣ Parcialmente 😅\n3️⃣ No pude 😔`, delay: 700 },
      { from: 'patient', text: '2', delay: 1300 },
      { from: 'typing', delay: 900 },
      { from: 'bot', text: `¡Lo importante es la constancia, no la perfección! 🌟 Su próximo control es el martes. ¿Alguna duda del plan de alimentación?`, delay: 1500 },
    ],
    confundido: [
  ...
  'fisioterapia': {
    ...
    ejercicios: [
      { from: 'bot', text: `Buenos días Juan 🏋️ Hoy toca:\n1. Estiramiento de rodilla (3×10)\n2. Sentadillas parciales (2×8)\n3. Caminar 15 min\n━━━━━━━━\n40% (8/20 sesiones)\n\n¿Completó los ejercicios?\n1️⃣ Sí ✅\n2️⃣ Algunos\n3️⃣ Hoy no`, delay: 700 },
    ],
    confundido: [
  ...
  'ginecologia': {
    ...
    timeline: [
      { from: 'bot', text: `¡Hola Ana! 🤰 Semana 20 de su embarazo.\n\n📋 Es momento de su ecografía morfológica. ¿La agendo con el Dr. Rodríguez?\n📅 Lunes 9:00 AM\n📅 Miércoles 2:00 PM`, delay: 700 },
    ],
    confundido: [
  ...
  'pediatria': {
    ...
    'urgencia-2am': [
      { from: 'patient', text: 'Mi bebé tiene 38.5 de fiebre, qué hago?', delay: 700 },
      { from: 'typing', delay: 1100 },
      { from: 'bot', text: `Entiendo su preocupación. Con 38.5°C:\n✅ Darle el medicamento recetado por el Dr. Pérez\n✅ Ropa ligera e hidratación\n⚠️ Si supera 39°C o dura más de 48h → urgencias.\n\n¿Agendo cita mañana primera hora?`, delay: 1700 },
    ],
    confundido: [
  ...
  'oftalmologia': {
    ...
    'pre-quirurgico': [
      { from: 'bot', text: `Su cirugía LASIK es en 3 días. Checklist pre-operatorio:\n☐ No usar lentes de contacto desde hoy\n☐ Ayuno 8 horas antes\n☐ Venir acompañado\n☐ Traer gafas oscuras\n\n¿Confirma que entendió?\n1️⃣ Sí ✅\n2️⃣ Tengo dudas 💬`, delay: 700 },
    ],
    confundido: [
